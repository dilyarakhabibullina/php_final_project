...
class Catalog{
    ...
    public function getCatalog () {
        ...
        return DB::instance()->query("SELECT * FROM `goods` LIMIT $limit")->fetchAll();
       //return $row;
     }
    ...
    public function getGood($id){
       // $id = $_GET['id'];
        return DB::instance()->query("SELECT * FROM `goods` WHERE id='$id'")->fetch();
    }
    }
    // $item=new Catalog();
    // $item->getGood(7);
...
//     //global $db;
//     return DB::instance()->query("INSERT INTO `orders` (user_id) VALUES ($user_id)");
// }
